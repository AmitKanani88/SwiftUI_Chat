...
//            let contentView = ChatVC(userName: user)
//
...
//        }
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        UserDefaultKeys.userDefaults.set("9Zm1agGeTlWmV1gxoYvn1eWCHy02", forKey: UserDefaultKeys.UD_UserId)
